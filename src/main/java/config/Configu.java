 ...
 * org.springframework.context.annotation.ComponentScans; import
 ...
 * 
 * @ComponentScan("Service")}) public class Configu {
 * 
 ...
 * sessionFactory.setPackagesToScan(ENTITYMANAGER_PACKAGES_TO_SCAN); Properties
 ...
 * new DriverManagerDataSource(); dataSource.setDriverClassName(DB_DRIVER);
